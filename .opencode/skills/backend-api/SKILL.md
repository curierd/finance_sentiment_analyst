...
# 更新配图
updated = repo.update_image(comment_id, local_image_path="comments/images/bilibili/test.jpg")
updated = repo.update_image(comment_id, original_url="https://example.com/img.jpg")
updated = repo.update_image(comment_id, local_image_path="...", original_url="...")
...
# 更新配图（评论不存在抛 ValueError）
svc.update_image(comment_id, local_image_path="comments/images/bilibili/test.jpg")
svc.update_image(comment_id, original_url="https://example.com/img.jpg")
...
| PATCH | `/api/comments/<id>/image` | body: `{local_image_path, original_url}` | 更新配图路径 |
| POST | `/api/comments/<id>/image/upload` | form-data: `file`, 可选`original_url` | 上传配图文件 |
| DELETE | `/api/comments/<id>` | — | 删除评论 |
| GET | `/api/stats` | — | 聚合统计 |
| GET | `/api/stats/timeline` | granularity: day/week/month | 时间线统计 |
| GET | `/api/up_masters` | — | UP主列表 |
| GET | `/api/videos` | — | 视频列表 |
| GET | `/comments/images/<path>` | — | 配图静态文件服务 |
